...
// --- Custom Cursor ---
(function () {
    // Su dispositivi touch non serve il cursore custom
    ...
    // Hover state: solo quando si è già entrati nel sito
    const hoverTargets = 'a, button, input[type="range"], .volume-icon, .control-btn, .crop-btn';
    document.addEventListener('mouseover', (e) => {
        if (hasEntered && e.target.closest(hoverTargets)) document.body.classList.add('cursor-hover');
    });
    ...
    // Nascondi quando il mouse esce dalla finestra, mostra sempre al rientro
